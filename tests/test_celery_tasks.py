...
class TestSyncAllToursTask:
    """Test the daily sync task that runs all 3 scrapers."""

    @patch("apps.importer.tasks.call_command")
    def test_calls_all_three_sources(self, mock_call_command):
        ...
        assert result == {"zego": "ok", "go365": "ok", "realjourney": "ok"}
    ...
    def test_sources_list_complete(self):
        """Verify all 3 expected sources are in SOURCES constant."""
